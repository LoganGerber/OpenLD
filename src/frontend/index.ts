...
selectables.forEach((selectable: Element) => {
	selectable.addEventListener('click', sendSelectionRequest);
});
...
function sendSelectionRequest(_: Event) {
	ipcRenderer.send('LOL', '1234');
}
